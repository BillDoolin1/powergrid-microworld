...
const LEVELS = {
  ...
  2: {
    ...
    investments: [
      ...
      {
        id: "public-awareness",
        label: "National Energy Awareness Campaign",
        costM: 150,
        effect: { ggeReduction: 1.5 },
        tooltip: "Encourages households and businesses to switch to cleaner energy, reducing overall grid emissions.",
      },
    ],
  },
  3: {
